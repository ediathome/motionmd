...
set_target_properties(libcmark PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libcmark.0.28.3.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libcmark.0.28.3.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS libcmark )
list(APPEND _IMPORT_CHECK_FILES_FOR_libcmark "${_IMPORT_PREFIX}/lib/libcmark.0.28.3.dylib" )
